...
$site  =iconv('euc-kr','utf-8',$_GET['site']);			//실제저장된 파일명
if($site=='재단'){
	$downfiledir='../../../ansanyouth/www/board/upfile/';
}elseif($site=='상록'){
	$downfiledir='../../../sangnok/www/board/upfile/';
}elseif($site=='단원'){
	$downfiledir='../../../danwon/www/board/upfile/';
}elseif($site=='일동'){
	$downfiledir='../../../ildong/www/board/upfile/';
}elseif($site=='사동'){
	$downfiledir='../../../sadong/www/board/upfile/';
}elseif($site=='CI'){
	$downfiledir='../../../ansanyouth/www/upfile/';
}
