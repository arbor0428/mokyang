	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				...
				<tr align="" height='30'>
					<th width="10%" class='bbs'>작성자</th>
					
					<?
						if($table_id=='table_1628232234'){
					?>
					<th width="15%" class='bbs'>연락처</th>
					<th width="15%" class='bbs'>상담구분</th>
					<?
						}	
					?>
					
					<th width="*" class='bbs'>제목</th>
					<th width="10%" class='bbs'>등록일</th>
				</tr>
						...
						<table cellpadding='0' cellspacing='0' border='0' width='100%'>
							...
							<?
								if($download_chk){
									if($UserOS=='pc'){
							?>
								<td width='80' align='right'><a href="javascript:file_down('FRM','<?=$file_num?>','<?=$site?>');" class='mini cbtn black'>다운로드</a></td>
							<?
									}else{
							?>
								<td width='80' align='right'><a href="javascript:file_down_m('<?=${'userfile'.$file_num}?>','<?=${'realfile'.$file_num}?>','<?=$site?>');" class='mini cbtn black'>다운로드</a></td>
							<?
									}
								}
							?>
