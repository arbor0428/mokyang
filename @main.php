...
<section>
            ...
            <div class="boardWrap">
                ...
                <div id="tabmenu2" class="tab" data-aos="fade-up" data-aos-easing="ease" data-aos-duration="1000">
                    <ul id="btn2" class="tabbtn clearfix f19 bolder">
                        <li class="on"><a href="/sub06/sub04.php" title="육아정보나눔게시판">육아정보나눔게시판</a></li>
                    </ul>
                    <a class="plusBtn" href="/sub06/sub04.php"><span class="lnr lnr-plus-circle"></span></a>
                    <div id="cont2" class="tabcont">
                        <ul class="cont-list">
						<?
							$item = sqlArray("select * from tb_board_list where table_id='table_1640048648' order by uid desc limit 5");
							if($item){
								foreach($item as $k => $v){
						?>
                            <li>
    ...
    <div class="cont3">
        <div class="center">
            <h3 class="f42">지원서비스</h3>
            <div class="serviceWrap">
                <div class="service" data-aos="fade-up" data-aos-easing="ease" data-aos-duration="1000">
                    <a href="/sub06/sub06.php" title="service01">
                        <div class="imgWrap">
                            <img src="images/common/bnr_thumb01.jpg" alt="서비스1">
                        </div>
                        <h5 class="f26">다함께 돌봄</h5>
                        <!--<p class="ser-detail f15">다함께 돌봄에 대한 설명이 들어갑니다.(미정)</p>-->
                    </a>
                </div>
                <div class="service" data-aos="fade-up" data-aos-easing="ease" data-aos-duration="1000">
                    <a href="/sub06/sub06_2.php" title="service02">
                        <div class="imgWrap">
                            <img src="images/common/bnr_thumb02.jpg" alt="서비스2">
                        </div>
                        <h5 class="f26">지역아동센터</h5>
                        <!--<p class="ser-detail f15">다함께 돌봄에 대한 설명이 들어갑니다.(미정)</p>-->
                    </a>
                </div>
                <div class="service" data-aos="fade-up" data-aos-easing="ease" data-aos-duration="1000">
                    <a href="/sub06/sub06_3.php" title="service03">
                        <div class="imgWrap">
                            <img src="images/common/bnr_thumb03.jpg" alt="서비스3">
                        </div>
                        <h5 class="f26">학교 돌봄</h5>
                        <!--<p class="ser-detail f15">다함께 돌봄에 대한 설명이 들어갑니다.(미정)</p>-->
                    </a>
                </div>
            </div>
