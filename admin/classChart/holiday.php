...
$sYear = date('Y',$eTime01);
$eYear = date('Y',$eTime02);

for($h=$sYear; $h<=$eYear; $h++){
	$tmp = lun2sol($h."0101");   //설날
	$HOLIDAY[$h.date("md",($tmp-(3600*24)))] = '설연휴';
	$HOLIDAY[$h.date("md",$tmp)] = '설연휴';
	$HOLIDAY[$h.date("md",($tmp+(3600*24)))] = '설연휴';

	$tmp = lun2sol($h."0408");   //석가탄신일
	$HOLIDAY[$h.date("md",$tmp)] = '석가탄신일';

	$tmp = lun2sol($h."0815");   //추석
	$HOLIDAY[$h.date("md",($tmp-(3600*24)))] = '추석연휴';
	$HOLIDAY[$h.date("md",$tmp)] = '추석연휴';
	$HOLIDAY[$h.date("md",($tmp+(3600*24)))] = '추석연휴';
...
$HOLIDAY['20180507'] = '대체공휴일';
$HOLIDAY['20180613'] = '지방선거';
$HOLIDAY['20180926'] = '대체공휴일';
