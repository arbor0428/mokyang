<?
	...
	if($type=='edit' && $uid){
		$sql = "select c.*, p.package as packageProgram from ks_userClass as c left join ks_program as p on c.programID=p.uid where c.uid='$uid'";
...
?>
	...
	<table cellpadding='0' cellspacing='0' border='0' width='100%' class='zTable'>
		...
		<tr>
			...
			<td colspan='3'><input name="payAmt" id="payAmt" style="width:120px;" type="text" value="<?=$payAmt?>" class='numberOnly'>원</td>
		</tr>
<?
