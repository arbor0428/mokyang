<?
	//회원별 휴대전화번호
	$psql = "select * from ks_userlist order by uid desc";
...
?>
	...
	-->
		...
		<td onclick="<?=$javaLink?>" style='line-height:25px;'><?=$payModeTxt?><?=$deviceChk?></td>
