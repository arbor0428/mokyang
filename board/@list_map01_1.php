...
table#locationTbl td {padding:10px;}
table#locationTbl td.bbs01 {border-bottom:1px solid #e1e1e1;}
table#locationTbl td.top {border:1px solid #bcbcbc; border-left:0px; border-right:0px; background-color:#f6f6f6; padding:10px; text-align:center;}
	...
	<tr>
		<!--<td style="border:1px solid #bcbcbc; border-left:0px; border-right:0px; background-color:#f6f6f6; padding:8px 0px; text-align:center;">-->
			...
			<table cellpadding='0' cellspacing='0' border='0' width='100%'>
				<tr align='center'>
					<td width="4%" class='b-text'><span class="smooth dp_ir">번호</span></td>
					<td width="18%" class='b-text'><span class="smooth dp_ir">센터명</span></td>
					<td width="*" class='b-text'><span class="smooth dp_ir">주소</span></td>
					<td width="5%" class='b-text'><span class="smooth dp_ir">위치</span></td>
					<td width="15%" class='b-text'><span class="smooth dp_ir">연락처</span></td>
					<td width="10%" class='b-text'><span class="smooth dp_ir">운영시간</span></td>
					<td width="10%" class='b-text'><span class="smooth dp_ir">정원</span></td>
					<td width="5%" class='b-text'><span class="smooth dp_ir">홈페이지</span></td>
					<td width="10%" class='b-text'><span class="smooth dp_ir">편집</span></td>
				</tr>
			</table>
		</td>
	</tr>
...
?>
	...
	<tr>
		<td style="border:1px solid #bcbcbc; border-left:0px; border-right:0px; background-color:#f6f6f6; padding:8px; text-align:center;">
			<table cellpadding='0' cellspacing='0' border='0' width='100%'>
				<tr align='center'>
					<td width="4%" class='b-text'><span class="smooth dp_ir">번호</span></td>
					<td width="18%" class='b-text'><span class="smooth dp_ir">센터명</span></td>
					<td width="*" class='b-text'><span class="smooth dp_ir">주소</span></td>
					<td width="10%" class='b-text'><span class="smooth dp_ir">위치</span></td>
					<td width="10%" class='b-text'><span class="smooth dp_ir">연락처</span></td>
					<td width="10%" class='b-text'><span class="smooth dp_ir">운영시간</span></td>
					<td width="10%" class='b-text'><span class="smooth dp_ir">정원</span></td>
					<td width="5%" class='b-text'><span class="smooth dp_ir">홈페이지</span></td>
				</tr>
...
?>
				<tr height='45'>
					...
					<td class='bbs01' width='*' style='padding-left:10px;'><span class="smooth dp_ir"><?=$sData03?> <?=$sData04?></span></td>
...
?>
				<tr height='45'>
					<td class='bbs01' width='4%' align='center'><?=$i?></td>
					<td class='bbs01' width='18%' align='center'><?=$title?></td>
