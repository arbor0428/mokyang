...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'> 
	...
	<tr>
		<td>
		<?
			include $calendarRoot.'calendar02.php';
		?>
		</td>
	</tr>
...
<label for="year"><input type='hidden' name='year' value='<?=$year?>'></label>
<label for="month"><input type='hidden' name='month' value='<?=$month?>'></label>
<label for="day"><input type='hidden' name='day' value=''></label>
