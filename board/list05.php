...
?>
					...
					<td width='50%' height='30' align='right'>
						<select name="field" style='height:30px;'>
							<option value='name' <?if($field == 'name') echo 'selected';?>>분류</option>
							<option value='title' <?if($field == 'title') echo 'selected';?>>질문</option>
							<option value='ment' <?if($field == 'ment') echo 'selected';?>>답변</option>
						</select>
