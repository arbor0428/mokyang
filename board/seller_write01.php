...
?>
				...
				<tr> 
					...
					<th width="17%">비밀번호</th>
					<td width="33%">
						<label for="passwd"><input name="passwd" type="password" style='width:100px;height:28px;' value="<?=$passwd?>" class='3tt5'></label>
						<label for="pwd_chk"><input type='radio' name='pwd_chk' value='' <?if(!$pwd_chk) echo 'checked';?>></label>공개
						<label for="pwd_chk"><input type='radio' name='pwd_chk' value='1' <?if($pwd_chk) echo 'checked';?>></label>비공개
					</td>
				</tr>
