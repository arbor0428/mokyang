...
<style>
.photobox{width:35%;height:auto;float:left;}
.txtbox{width:62%; float:right;}
.txtbox th, .txtbox td{font-size:16px;}
.txtbox th.txt-tit{
	font-size:22px;
	letter-spacing:-1;
	padding-bottom:15px;
...
@media screen and (max-width:768px) {
	...
	.txtbox{width: 100%; float: none; margin: 10% auto;}
	.txtbox th, .txtbox td{font-size: 13px;}
	.txtbox th.txt-tit{font-size: 20px; padding-bottom: 5px; text-align: center;}
	.txtbox .thum-tt{background: #f7f7f7; border: 0; padding: 10px 15px;}
}
...
<!--등록-->
<!-- <a href="https://www.efac.or.kr/<?=$PHP_SELF?>?type=view&uid=<?=$uid?>" onclick="copy_trackback(this.href); return false;" style='position:relative; float:right; background:#666;display:none;' class="small cbtn black">주소복사</a> -->
<table cellpadding='0' cellspacing='0' border='0' width='100%'>
	
	<tr>
		<td>
			<div class="photobox"><?=$userfile?></div>

			<table cellpadding='0' cellspacing='0' border='0' class='zTable0 txtbox'>
				<tr>
					<th colspan='2' class="txt-tit"><?=$title?></th>
				</tr>
				<tr>
					<th style=''>장르</th>
					<td style=''><?=$sData01?></td>
				...
				<tr>
					...
					<td height='120' class="thum-tt"><?=$sDataTxt?></td>
				</tr>
				<tr>
					<th>주최</th>
					<td><?=$sData05?></td>
